...
//   return (
//     (<motion.div
//         className="h-4 w-4 rounded-full absolute z-50"  // Higher z-index
//         style={{
//           top: y,
//           left: x,
//           pointerEvents: "none",
...
export const FollowerPointerCard = ({
  ...
  return (
    <div
      ...
      style={{ cursor: "none" }}
      ref={ref}
      className={cn("relative z-20", className)} // Added higher z-index for visibility
    >
      <AnimatePresence>
        {isInside && <FollowPointer x={x} y={y} title={title} />}
      </AnimatePresence>
...
export const FollowPointer = ({ x, y, title }) => {
  ...
  return (
    <motion.div
      className="h-4 w-4 rounded-full absolute z-50" // Ensuring pointer has a high z-index
