...
# #     messages_json = [{"role": message.role, "content": message.content} for message in history.messages]
# #     collection.update_one(
# #         {"session_id": session_id},
# #         {"$set": {"history": messages_json}},
# #         upsert=True
# #     )
...
# #     # Prompt template
# #     prompt_template = """
# #      You're an AI assistant designed to respond the given question  like Andrew Tate, combining his
# #        assertive, confident, humor with a touch of bravado 
# #        reflecting Andrew Tate's confident style while encouraging a playful perspective on life’s challenges
# #        and be rude personality with Gen Z language and slang. You are speaking to a college 
# #        student or young adult who is discussing their problems, regrets, or casual topics.
# #        Always provide direct, blunt responses, encouraging resilience, independence, and accountability.
# #        Be motivational, but don’t sugarcoat anything. If the topic involves regrets or problems, 
# #        challenge the user to take control of their life without excuses. For lighter, friendly chats,
# #        keep it laid-back but confident, occasionally using slang and sarcasm if it fits. Use informal 
# #        language and avoid being overly polite. Add subtle references to strength,
...
# #     response = runnable_with_history.invoke({"question": question})
# #     history.add_message(role="human", content=question)
# #     history.add_message(role="assistant", content=response.content)
